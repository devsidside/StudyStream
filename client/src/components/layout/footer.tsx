    ...
    <footer className="bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-md mx-auto mb-6">Your complete student resource hub connecting academics, services, and community.</p>
          
          {/* Quick CTA */}
          <Button 
            className="bg-primary text-primary-foreground px-8 py-3 rounded-xl hover:bg-primary/90 transition-colors mb-8"
            onClick={() => window.location.href = "/api/login"}
            data-testid="button-footer-join-free"
          >
            Join Free
          </Button>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-foreground transition-colors" data-testid="footer-link-features">Features</a></li>
              <li><a href="#" className="hover:text-foreground transition-colors" data-testid="footer-link-blog">Blog</a></li>
            </ul>
          </div>
          
          {/* Students Column (Primary) */}
          <div className="space-y-4">
            <h3 className="font-semibold text-lg">Students</h3>
            <ul className="space-y-3 text-muted-foreground">
              <li><Link href="/browse"><a className="hover:text-foreground transition-colors" data-testid="footer-link-notes">Notes</a></Link></li>
          ...
          {/* Vendors Column (Small) */}
          <div className="space-y-4">
            <h3 className="font-semibold text-base text-muted-foreground">Vendors</h3>
        ...
        <div className="border-t border-border pt-8 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              ...
              <p className="text-muted-foreground text-sm">Get resources delivered to your inbox</p>
            </div>
